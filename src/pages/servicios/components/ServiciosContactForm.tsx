...
export default function ServiciosContactForm() {
  ...
  return (
    <section id="contacto-servicios" className="relative py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6">
        <div className="text-center mb-10">
          ...
          <h2 className="font-heading font-800 text-3xl md:text-4xl text-background-50">
            ¿Podemos ayudarte?
          </h2>
          <p className="text-background-300 mt-3 text-sm max-w-lg mx-auto">
            Nuestros expertos te responderán con la mayor brevedad. Escríbenos a{' '}
            <a href="mailto:gerencia@actilogistics.com" className="text-accent-400 hover:underline" rel="nofollow">
        ...
        {status === 'success' ? (
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {/* País */}
              <div>
                <label htmlFor="srv-pais" className="block text-xs font-label font-700 text-background-300 uppercase tracking-wider mb-1.5">
              ...
              {/* Servicio de interés */}
              <div>
                <label htmlFor="srv-servicio" className="block text-xs font-label font-700 text-background-300 uppercase tracking-wider mb-1.5">
              ...
              {/* Nombre */}
              <div>
                <label htmlFor="srv-nombre" className="block text-xs font-label font-700 text-background-300 uppercase tracking-wider mb-1.5">
              ...
              {/* Empresa */}
              <div>
                <label htmlFor="srv-empresa" className="block text-xs font-label font-700 text-background-300 uppercase tracking-wider mb-1.5">
              ...
              {/* Email */}
              <div>
                <label htmlFor="srv-email" className="block text-xs font-label font-700 text-background-300 uppercase tracking-wider mb-1.5">
              ...
              {/* Teléfono */}
              <div>
                <label htmlFor="srv-telefono" className="block text-xs font-label font-700 text-background-300 uppercase tracking-wider mb-1.5">
            ...
            {/* Comentarios */}
            <div>
              <label htmlFor="srv-comentarios" className="block text-xs font-label font-700 text-background-300 uppercase tracking-wider mb-1.5">
                Comentarios
              </label>
              <textarea
                id="srv-comentarios"
                ...
                rows={4}
                maxLength={500}
                placeholder="Cuéntanos sobre tu necesidad de transporte o logística..."
