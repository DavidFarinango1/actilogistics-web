    ...
    <section className="relative h-[420px] md:h-[560px] flex items-end pb-16 overflow-hidden">
      <div className="absolute inset-0">
        <img
          ...
          alt="Sostenibilidad Actilogistics - Compromiso con el planeta"
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6">
        ...
        <p className="text-background-300 text-base md:text-lg max-w-2xl leading-relaxed">
          Nos alineamos con los Objetivos de Desarrollo Sostenible de la ONU. El crecimiento empresarial y la responsabilidad con el planeta van de la mano en Actilogistics.
        </p>
